package com.xxx.pay.zhifubao.service.impl;
...
import com.xxx.pay.zhifubao.config.Constants;
import com.xxx.pay.zhifubao.model.TradeStatus;
import com.xxx.pay.zhifubao.model.builder.AlipayTradeCancelRequestBuilder;
...
import com.xxx.pay.zhifubao.utils.Utils;
...
abstract class AbsAlipayTradeService extends AbsAlipayService implements AlipayTradeService {
    ...
    public AlipayF2FPrecreateResult tradePrecreate(AlipayTradePrecreateRequestBuilder builder) {
        ...
        request.setNotifyUrl(builder.getNotifyUrl());
        request.putOtherTextParam("app_auth_token", builder.getAppAuthToken());  //扫码支付时，这里为null的
        request.setBizContent(builder.toJsonString());
