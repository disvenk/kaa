 ...
 */
@Entity
@Table(name = "sup_order_testing_log")
@TableGenerator(name="idGenerator",table="SYS_Table_Generator",pkColumnName = "name",valueColumnName = "value",pkColumnValue="sup_order_testing_log", allocationSize=1)
public class SupOrderTestingLog extends GenericEntity {
