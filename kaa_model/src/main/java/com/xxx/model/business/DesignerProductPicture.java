 ...
 */
@Entity
@Table(name = "des_product_picture")
@TableGenerator(name="idGenerator",table="SYS_Table_Generator",pkColumnName = "name",valueColumnName = "value",pkColumnValue="des_product_picture", allocationSize=1)
public class DesignerProductPicture extends GenericEntity {
