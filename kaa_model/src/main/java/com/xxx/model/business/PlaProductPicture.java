 ...
 */
@Entity
@Table(name = "pla_product_picture")
@TableGenerator(name="idGenerator",table="SYS_Table_Generator",pkColumnName = "name",valueColumnName = "value",pkColumnValue="pla_product_picture", allocationSize=1)
public class PlaProductPicture extends GenericEntity {
