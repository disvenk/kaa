 ...
 */
@Entity
@Table(name = "sal_product_price")
@TableGenerator(name="idGenerator",table="SYS_Table_Generator",pkColumnName = "name",valueColumnName = "value",pkColumnValue="sal_product_price", allocationSize=1)
public class SalesProductPrice extends GenericEntity {
