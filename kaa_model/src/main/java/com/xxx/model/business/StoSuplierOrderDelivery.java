 ...
 */
@Entity
@Table(name = "sto_suplierorder_delivery")
@TableGenerator(name="idGenerator",table="SYS_Table_Generator",pkColumnName = "name",valueColumnName = "value",pkColumnValue="sto_suplierorder_delivery", allocationSize=1)
public class StoSuplierOrderDelivery extends GenericEntity {
