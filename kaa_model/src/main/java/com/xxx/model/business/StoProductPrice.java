 ...
 */
@Entity
@Table(name = "sto_product_price")
@TableGenerator(name="idGenerator",table="SYS_Table_Generator",pkColumnName = "name",valueColumnName = "value",pkColumnValue="sto_product_price", allocationSize=1)
public class StoProductPrice extends GenericEntity {
