$(function(){
    function initTableCheckbox() {
        ...
        //删除每一项
        $('#sample-table-1 .delete').click(function () {
            var _this = $(this);
            $('#myModal').modal('show');
           $('.sure').click(function () {
        ...
        $('#footer .delete_all').click(function () {
            $('#sample-table-1 .delete').parent().parent().remove();
        });
        //商品数量加减
        $('#sample-table-1 td .glyphicon-plus-sign').click(function () {
            var num = $(this).siblings('input').val() - 0 + 1;
            $(this).siblings('input').val(num);
        });
        $('#sample-table-1 td .glyphicon-minus-sign').click(function () {
