...
function detail() {
    ...
    $.ajax({
        type: 'POST',
        url: urlle + 'designerProduct/designerProductManageEditDetail',
        dataType: 'json',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Accept': 'application/json; charset=utf-8',
...
$('#confirm').click(function () {
    if($('.progress').css('display') == 'block'){
        ...
        for (var i = 0; i < table.length; i++) {
            ...
            designerProductPriceList[i] = obj;
        }
        ...
        var data = {
            ...
            sales: sales,
            colligate: colligate,
            designerProductPriceList: designerProductPriceList,
            designerProductPictureList: imgs,
            designerProductLabelList: check_val
        };
        ...
        if (name == '') {
            ...
            $.ajax({
                type: 'POST',
                url: urlle + 'designerProduct/updateDesignerProductManage',
                dataType: 'json',
                contentType: 'application/json; charset=utf-8',
                headers: {
                    'Accept': 'application/json; charset=utf-8',
