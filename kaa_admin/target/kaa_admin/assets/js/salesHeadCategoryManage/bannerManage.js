...
function initData() {
    $.ajax({
        type: 'POST',
        url: urlle+'banner/findBannerList',
        dataType: 'json',
...
function load(res) {
    ...
    $('#surehide').click(function () {
        $.ajax({
            type: 'POST',
            url: urlle + 'banner/setDisabledBanner',
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            headers: {
                'Accept': 'application/json; charset=utf-8',
    ...
    $('.add').click(function () {
        var _this = $(this);
        id = _this.parent().parent().attr('class');
        location.href = '../banner/bannerProductManageHtml?id=' + id + ''
    });
    //编辑
    $('.edit').click(function () {
        var _this = $(this);
        id = _this.parent().parent().attr('class');
        location.href = '../banner/bannerEditHtml?id=' + id + ''
    });
}
...
$('#btnAdd').click(function () {
    location.href = '../banner/bannerAddHtml';
});