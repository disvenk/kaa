...
var data = {
    ...
    sortType: 1,*/
    pageNum: 1,
    salesProductCategoryList: [],
    salesProductLabelList: []
};
//标签
$.ajax({
    type: 'POST',
...
function post() {
    ...
    $.ajax({
        type: 'POST',
        url: urlle + 'salesProduct/storeAddProductManageList',
        dataType: 'json',
        contentType: 'application/json; charset=utf-8',
        headers: {
            'Accept': 'application/json; charset=utf-8',
...
function load(res) {
    ...
    $('#list li .goods-item-img').click(function () {
        ...
        location.href = '../product/showGoodsManageDetailHtml?id='+goodsId+''
    });
}
/*
...
function choose() {
    ...
    data.salesProductCategoryList = [];
    data.plaProductLabeiId = [];
    for(var i = 0; i < cate.length; i++){
        data.salesProductCategoryList[i] = {
            categoryId: ''
        };
        data.salesProductCategoryList[i].categoryId = cate.eq(i).attr('class');
    }
    var label = $('#yourChoose div');
    for(var i = 0; i < label.length; i++){
        data.salesProductLabelList[i] = {
            labelId: ''
        };
        data.salesProductLabelList[i].labelId = label.eq(i).attr('class');
    }
    post();
}
