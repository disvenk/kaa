...
*/
public class DesignerProductManageForm {
public String brand;
public Double sort;
...
public List<DesignerProductManagePriceListForm> designerProductPriceList = new ArrayList<>(); //商品明细集合

public List<DesignerProductManagePictureListForm> designerProductPictureList = new ArrayList<>();//商品图片集合

public List<DesignerProductManageLabelListForm> designerProductLabelList = new ArrayList<>();//商品标签集合
